...
class Detector
{
  ...
  static parseRobotsTxt(robotsTxt)
  {
    ...
    robotsTxt.split('\n')
      .forEach((line) =>
      {
        ...
        } else if (userAgent === '*' || userAgent === 'detector')
        {
  ...
  ping()
  {
    if (Object.keys(this.hostnameCache)
      .length > 100)
    {
